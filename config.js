const nameGirl = 'Cô gái';
const giftUrl = 'https://www.facebook.com/thaianh196/';
const eventName = 'Chúc Mừng Sinh Nhật';
const titleCard = 'Tặng đằng ấy';
const contentCard = 'Chúc sinh nhật Mei 20/1 tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với Mei trong hôm nay và cả những ngày sau';
